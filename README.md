...
[![CI](https://github.com/El-Mangusto/car-rental-backend-service/actions/workflows/ci.yml/badge.svg)](https://github.com/El-Mangusto/car-rental-backend-service/actions/workflows/ci.yml)
...
- **Self-protection guards** — an admin cannot ban or downgrade their own account, preventing accidental lockout.
...
- **Continuous Integration** — a GitHub Actions workflow runs the full `mvnw verify` suite (unit + Testcontainers-based integration tests) on every push and pull request to `master`.
## Running the Project
